...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md card-gradient shadow-soft border p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
