...
import { useListaChequeoConsolidado } from "@/hooks/use-lista-chequeo-consolidado"
...
export function ChecklistConsolidated() {
  ...
  const datosConsolidados = useListaChequeoConsolidado()
    ...
    <Card className="dashboard-card col-span-full">
      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          {selectedEtapa === "todas" && selectedArea === "todas" && activeTab === "grafico" && (
            <div className="bg-blue-500/10 text-blue-500 p-3 rounded-md text-sm mb-2">
              Mostrando consolidado por etapas. Seleccione una etapa o área específica para ver más detalles.
            </div>
          )}
